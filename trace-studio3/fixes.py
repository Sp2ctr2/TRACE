...
p.write_text(s)
# Compile concrete generated page specs alongside the app. The editor emits this same wrapper.
...
print('Native source syntax normalized and',len(project['screens']),'generated page specs installed')
